...
import { FaChartLine, FaUsers, FaEye, FaHeart, FaArrowUp, FaArrowDown, FaCalendarAlt } from 'react-icons/fa'
        ...
        <TabPanels>
              ...
              <ChartCard title="일별 성과 추이">
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={performanceData}>
                    ...
                    <YAxis />
                    <Tooltip />
                    <Line type="monotone" dataKey="views" stroke="#3182CE" strokeWidth={2} />
                    <Line type="monotone" dataKey="likes" stroke="#E53E3E" strokeWidth={2} />
                    <Line type="monotone" dataKey="clicks" stroke="#38A169" strokeWidth={2} />
                  </LineChart>
                </ResponsiveContainer>
              </ChartCard>
          ...
          <TabPanel p={0} pt={6}>
            <Grid templateColumns={{ base: '1fr', lg: '1fr 1fr' }} gap={6}>
              ...
              <Card bg={cardBg} borderColor={borderColor}>
                <CardHeader>
                  <Text fontSize="lg" fontWeight="bold">고객 세그먼트 상세</Text>
                </CardHeader>
                <CardBody>
            ...
            <ChartCard title="경쟁사 대비 성과 비교">
              <ResponsiveContainer width="100%" height={400}>
                <RadarChart data={competitorData}>
                  ...
                  <Radar name="우리" dataKey="우리" stroke="#3182CE" fill="#3182CE" fillOpacity={0.3} />
                  <Radar name="경쟁사1" dataKey="경쟁사1" stroke="#E53E3E" fill="#E53E3E" fillOpacity={0.2} />
                  <Radar name="경쟁사2" dataKey="경쟁사2" stroke="#38A169" fill="#38A169" fillOpacity={0.2} />
                  <Tooltip />
                </RadarChart>
              </ResponsiveContainer>
            </ChartCard>
          ...
          <TabPanel p={0} pt={6}>
            <Grid templateColumns={{ base: '1fr', lg: '1fr 1fr' }} gap={6}>
              <Card bg={cardBg} borderColor={borderColor}>
                <CardHeader>
                  <Text fontSize="lg" fontWeight="bold">인기 키워드 트렌드</Text>
                </CardHeader>
                <CardBody>
                  <VStack spacing={4} align="stretch">
                    {trendingKeywords.map((item, index) => (
                      <Box key={index}>
                        <HStack justify="space-between">
                          ...
                          <HStack>
                            <Badge 
                              colorScheme={item.trend.includes('+') ? 'green' : 'red'}
                              display="flex" 
                              alignItems="center"
                              gap={1}
                            >
                              {item.trend.includes('+') ? <FaArrowUp /> : <FaArrowDown />}
                              {item.trend}
                            </Badge>
                          </HStack>
                        </HStack>
              ...
              <Card bg={cardBg} borderColor={borderColor}>
                <CardHeader>
                  <Text fontSize="lg" fontWeight="bold">AI 추천 인사이트</Text>
                </CardHeader>
                <CardBody>
                  <VStack spacing={4} align="stretch">
                    <Box p={4} bg="blue.50" borderRadius="md" borderLeft="4px solid" borderColor="blue.400">
                      ...
                      <Text fontSize="sm">
                        인스타그램 참여율이 20% 증가했습니다. 비슷한 콘텐츠를 더 자주 게시해보세요.
                      </Text>
                    </Box>
                    ...
                    <Box p={4} bg="green.50" borderRadius="md" borderLeft="4px solid" borderColor="green.400">
                      ...
                      <Text fontSize="sm">
                        30-39세 고객층의 반응이 좋습니다. 이 연령대를 대상으로 한 콘텐츠를 늘려보세요.
                      </Text>
                    </Box>
                    ...
                    <Box p={4} bg="orange.50" borderRadius="md" borderLeft="4px solid" borderColor="orange.400">
                      ...
                      <Text fontSize="sm">
                        '리뷰' 키워드 트렌드가 하락 중입니다. 대체 키워드를 고려해보세요.
                      </Text>
                    </Box>
                    ...
                    <Box p={4} bg="purple.50" borderRadius="md" borderLeft="4px solid" borderColor="purple.400">
                      ...
                      <Text fontSize="sm">
                        '친환경' 키워드가 급상승 중입니다. 관련 콘텐츠 제작을 고려해보세요.
                      </Text>
                    </Box>
                  </VStack>
                </CardBody>
